...
CTNG_SOURCE_URL_raspi="git{diorcety}:${HOME}/crosstool-ng#official#ctgitget-refs#trivial-fixes#case-insensitivity#\${BUILD_OS}-build#\${TARGET_OS_SUPER}-target#\${BUILD_OS}-build_\${TARGET_OS_SUPER}-target\${NON_LINUX_BUILD_TARGET_LINUX}#misc-hacks"
CTNG_SOURCE_URL_raspi2="git{diorcety}:${HOME}/crosstool-ng#official#ctgitget-refs#trivial-fixes#case-insensitivity#\${BUILD_OS}-build#\${HOST_OS}-host#\${TARGET_OS_SUPER}-target#\${BUILD_OS}-build_\${TARGET_OS_SUPER}-target\${NON_LINUX_BUILD_TARGET_LINUX}#misc-hacks"

# For WIP local development use this:
CTNG_SOURCE_URL_windows="git{diorcety}:${HOME}/crosstool-ng#official#post_suffix_prefix#ctgitget-refs#trivial-fixes#case-insensitivity#\${BUILD_OS}-build#\${TARGET_OS}-target#misc-hacks#debugging"
CTNG_SOURCE_URL_windows="git{diorcety}:${HOME}/crosstool-ng#official#ctgitget-refs#trivial-fixes#case-insensitivity#\${BUILD_OS}-build#\${TARGET_OS}-target#misc-hacks#debugging"
...
CTNG_SOURCE_URL_raspi="git{diorcety}:${REPOS}/crosstool-ng.diorcety#official#ctgitget-refs#trivial-fixes#post_suffix_prefix#case-insensitivity#\${BUILD_OS}-build#\${TARGET_OS_SUPER}-target#\${BUILD_OS}-build_\${TARGET_OS_SUPER}-target\${NON_LINUX_BUILD_TARGET_LINUX}#misc-hacks"
#CTNG_SOURCE_URL_raspi2="git{diorcety}:${REPOS}/crosstool-ng.diorcety#official#ctgitget-refs#trivial-fixes#post_suffix_prefix#case-insensitivity#\${BUILD_OS}-build#\${HOST_OS}-host#\${TARGET_OS_SUPER}-target#\${BUILD_OS}-build_\${TARGET_OS_SUPER}-target\${NON_LINUX_BUILD_TARGET_LINUX}#misc-hacks"
CTNG_SOURCE_URL_raspi2="git{diorcety}:${REPOS}/crosstool-ng.diorcety#official#ctgitget-refs#trivial-fixes#case-insensitivity#\${BUILD_OS}-build#\${HOST_OS}-host#\${TARGET_OS_SUPER}-target#\${BUILD_OS}-build_\${TARGET_OS_SUPER}-target\${NON_LINUX_BUILD_TARGET_LINUX}#misc-hacks"
CTNG_SOURCE_URL_steamsdk="git{diorcety}:${REPOS}/crosstool-ng.diorcety#official#ctgitget-refs#trivial-fixes#case-insensitivity#\${BUILD_OS}-build#\${HOST_OS}-host#\${TARGET_OS_SUPER}-target#\${BUILD_OS}-build_\${TARGET_OS_SUPER}-target\${NON_LINUX_BUILD_TARGET_LINUX}#misc-hacks"
CTNG_SOURCE_URL_steambox="git{diorcety}:${REPOS}/crosstool-ng.diorcety#official#ctgitget-refs#trivial-fixes#case-insensitivity#\${BUILD_OS}-build#\${HOST_OS}-host#\${TARGET_OS_SUPER}-target#\${BUILD_OS}-build_\${TARGET_OS_SUPER}-target\${NON_LINUX_BUILD_TARGET_LINUX}#misc-hacks"
CTNG_SOURCE_URL_osx="git{diorcety}:${REPOS}/crosstool-ng.diorcety#master"

CTNG_SOURCE_URL_steamsdk="git{diorcety}:${REPOS}/crosstool-ng.diorcery#official#ctgitget-refs#trivial-fixes#case-insensitivity#\${BUILD_OS}-build#\${HOST_OS}-host#\${TARGET_OS_SUPER}-target#\${BUILD_OS}-build_\${TARGET_OS_SUPER}-target\${NON_LINUX_BUILD_TARGET_LINUX}#misc-hacks"

# For WIP local development use this:
CTNG_SOURCE_URL_windows="git{diorcety}:${REPOS}/crosstool-ng.diorcety#official#ctgitget-refs#trivial-fixes#post_suffix_prefix#case-insensitivity#\${BUILD_OS}-build#\${TARGET_OS}-target#misc-hacks"
...
# rebase_onto_upstream "master" "https://github.com/crosstool-ng/crosstool-ng.git" "official" "trivial-fixes" "post_suffix_prefix" "ctgitget-refs" "case-insensitivity" "windows-build" "windows-target" "linux-build" "linux-target" "darwin-target" "misc-hacks" "windows-build_linux-target" "non-linux-build_linux-target" "windows-host"
# force_push                                                              "origin" "official" "trivial-fixes" "post_suffix_prefix" "ctgitget-refs" "case-insensitivity" "windows-build" "windows-target" "linux-build" "linux-target" "darwin-target" "misc-hacks" "windows-build_linux-target" "non-linux-build_linux-target" "windows-host"
...
eglibc-2.15 has a memory stomp in it:
...
# Hanging on Arch Linux, can't see why ..
# pushd /c/bbd-d/.build/src/eglibc-2_17
...
# Next error .. building steamsdk on Windows:
[ERROR]    ../../../../../src/gcc-5.1.0/libcilkrts/runtime/sysdep-unix.c:626:5: error: unknown type name 'Dl_info'
[ERROR]    ../../../../../src/gcc-5.1.0/libcilkrts/runtime/sysdep-unix.c:628:16: error: request for member 'dli_fname' in something not a structure or union

[ALL  ]    /usr/bin/bash ./libtool  --tag=CC   --mode=compile /e/d/bs/.build/x86_64-unknown-linux-gnu/build/build-cc-gcc-final/./gcc/xgcc -B/e/d/bs/.build/x86_64-unknown-linux-gnu/build/build-cc-gcc-final/./gcc/ -B/e/d/is/x86_64-unknown-linux-gnu/bin/ -B/e/d/is/x86_64-unknown-linux-gnu/lib/ -isystem /e/d/is/x86_64-unknown-linux-gnu/include -isystem /e/d/is/x86_64-unknown-linux-gnu/sys-include    -DPACKAGE_NAME="Cilk Runtime Library" -DPACKAGE_TARNAME="cilk-runtime-library" -DPACKAGE_VERSION="2.0" -DPACKAGE_STRING="Cilk Runtime Library 2.0" -DPACKAGE_BUGREPORT="cilk@intel.com" -DPACKAGE_URL="" -DPACKAGE="cilk-runtime-library" -DVERSION="2.0" -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE_ALLOCA_H=1 -DHAVE_ALLOCA=1 -DHAVE_ATTRIBUTE_VISIBILITY=1 -DHAVE_DLFCN_H=1 -DLT_OBJDIR=".libs/" -DHAVE_PTHREAD_AFFINITY_NP=1 -I. -I../../../../../src/gcc-5.1.0/libcilkrts  -I../../../../../src/gcc-5.1.0/libcilkrts/include -I../../../../../src/gcc-5.1.0/libcilkrts/runtime -I../../../../../src/gcc-5.1.0/libcilkrts/runtime/config/x86 -DIN_CILK_RUNTIME=1 -fcilkplus -I/e/d/bs/.build/x86_64-unknown-linux-gnu/buildtools/include -Wc,-pthread -I../../../../../src/gcc-5.1.0/libcilkrts/include -I../../../../../src/gcc-5.1.0/libcilkrts/runtime -I../../../../../src/gcc-5.1.0/libcilkrts/runtime/config/x86 -DIN_CILK_RUNTIME=1 -fcilkplus -std=c99 -g -Os -MT sysdep-unix.lo -MD -MP -MF .deps/sysdep-unix.Tpo -c -o sysdep-unix.lo `test -f 'runtime/sysdep-unix.c' || echo '../../../../../src/gcc-5.1.0/libcilkrts/'`runtime/sysdep-unix.c
[ALL  ]    libtool: compile:  /e/d/bs/.build/x86_64-unknown-linux-gnu/build/build-cc-gcc-final/./gcc/xgcc -B/e/d/bs/.build/x86_64-unknown-linux-gnu/build/build-cc-gcc-final/./gcc/ -B/e/d/is/x86_64-unknown-linux-gnu/bin/ -B/e/d/is/x86_64-unknown-linux-gnu/lib/ -isystem /e/d/is/x86_64-unknown-linux-gnu/include -isystem /e/d/is/x86_64-unknown-linux-gnu/sys-include "-DPACKAGE_NAME="Cilk Runtime Library"" -DPACKAGE_TARNAME="cilk-runtime-library" -DPACKAGE_VERSION="2.0" "-DPACKAGE_STRING="Cilk Runtime Library 2.0"" -DPACKAGE_BUGREPORT="cilk@intel.com" -DPACKAGE_URL="" -DPACKAGE="cilk-runtime-library" -DVERSION="2.0" -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE_ALLOCA_H=1 -DHAVE_ALLOCA=1 -DHAVE_ATTRIBUTE_VISIBILITY=1 -DHAVE_DLFCN_H=1 -DLT_OBJDIR=".libs/" -DHAVE_PTHREAD_AFFINITY_NP=1 -I. -I../../../../../src/gcc-5.1.0/libcilkrts -I../../../../../src/gcc-5.1.0/libcilkrts/include -I../../../../../src/gcc-5.1.0/libcilkrts/runtime -I../../../../../src/gcc-5.1.0/libcilkrts/runtime/config/x86 -DIN_CILK_RUNTIME=1 -fcilkplus -pthread -I/e/d/bs/.build/x86_64-unknown-linux-gnu/buildtools/include -I../../../../../src/gcc-5.1.0/libcilkrts/include -I../../../../../src/gcc-5.1.0/libcilkrts/runtime -I../../../../../src/gcc-5.1.0/libcilkrts/runtime/config/x86 -DIN_CILK_RUNTIME=1 -fcilkplus -std=c99 -g -Os -MT sysdep-unix.lo -MD -MP -MF .deps/sysdep-unix.Tpo -c ../../../../../src/gcc-5.1.0/libcilkrts/runtime/sysdep-unix.c  -fPIC -DPIC -o .libs/sysdep-unix.o

pushd /e/d/bs/.build/x86_64-unknown-linux-gnu/build/build-cc-gcc-final/x86_64-unknown-linux-gnu/libcilkrts
E:\d\is\x86_64-unknown-linux-gnu\sysroot\usr\include\dlfcn.h
PATH=/e/d/bs/.build/x86_64-unknown-linux-gnu/buildtools/bin:$PATH make

/usr/bin/bash ./libtool  --tag=CC   --mode=compile /e/d/bs/.build/x86_64-unknown-linux-gnu/build/build-cc-gcc-final/./gcc/xgcc -B/e/d/bs/.build/x86_64-unknown-linux-gnu/build/build-cc-gcc-final/./gcc/ -B/e/d/is/x86_64-unknown-linux-gnu/bin/ -B/e/d/is/x86_64-unknown-linux-gnu/lib/ -isystem /e/d/is/x86_64-unknown-linux-gnu/include -isystem /e/d/is/x86_64-unknown-linux-gnu/sys-include    -DPACKAGE_NAME=\"Cilk\ Runtime\ Library\" -DPACKAGE_TARNAME=\"cilk-runtime-library\" -DPACKAGE_VERSION=\"2.0\" -DPACKAGE_STRING=\"Cilk\ Runtime\ Library\ 2.0\" -DPACKAGE_BUGREPORT=\"cilk@intel.com\" -DPACKAGE_URL=\"\" -DPACKAGE=\"cilk-runtime-library\" -DVERSION=\"2.0\" -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE_ALLOCA_H=1 -DHAVE_ALLOCA=1 -DHAVE_ATTRIBUTE_VISIBILITY=1 -DHAVE_DLFCN_H=1 -DLT_OBJDIR=\".libs/\" -DHAVE_PTHREAD_AFFINITY_NP=1 -I. -I../../../../../src/gcc-5.1.0/libcilkrts  -I../../../../../src/gcc-5.1.0/libcilkrts/include -I../../../../../src/gcc-5.1.0/libcilkrts/runtime -I../../../../../src/gcc-5.1.0/libcilkrts/runtime/config/x86 -DIN_CILK_RUNTIME=1 -fcilkplus -I/e/d/bs/.build/x86_64-unknown-linux-gnu/buildtools/include -Wc,-pthread -I../../../../../src/gcc-5.1.0/libcilkrts/include -I../../../../../src/gcc-5.1.0/libcilkrts/runtime -I../../../../../src/gcc-5.1.0/libcilkrts/runtime/config/x86 -DIN_CILK_RUNTIME=1 -fcilkplus -std=c99 -g -Os -MT sysdep-unix.lo -MD -MP -MF .deps/sysdep-unix.Tpo -c -o sysdep-unix.lo `test -f 'runtime/sysdep-unix.c' || echo '../../../../../src/gcc-5.1.0/libcilkrts/'`runtime/sysdep-unix.c
libtool: compile:  /e/d/bs/.build/x86_64-unknown-linux-gnu/build/build-cc-gcc-final/./gcc/xgcc -B/e/d/bs/.build/x86_64-unknown-linux-gnu/build/build-cc-gcc-final/./gcc/ -B/e/d/is/x86_64-unknown-linux-gnu/bin/ -B/e/d/is/x86_64-unknown-linux-gnu/lib/ -isystem /e/d/is/x86_64-unknown-linux-gnu/include -isystem /e/d/is/x86_64-unknown-linux-gnu/sys-include "-DPACKAGE_NAME=\"Cilk Runtime Library\"" -DPACKAGE_TARNAME=\"cilk-runtime-library\" -DPACKAGE_VERSION=\"2.0\" "-DPACKAGE_STRING=\"Cilk Runtime Library 2.0\"" -DPACKAGE_BUGREPORT=\"cilk@intel.com\" -DPACKAGE_URL=\"\" -DPACKAGE=\"cilk-runtime-library\" -DVERSION=\"2.0\" -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE_ALLOCA_H=1 -DHAVE_ALLOCA=1 -DHAVE_ATTRIBUTE_VISIBILITY=1 -DHAVE_DLFCN_H=1 -DLT_OBJDIR=\".libs/\" -DHAVE_PTHREAD_AFFINITY_NP=1 -I. -I../../../../../src/gcc-5.1.0/libcilkrts -I../../../../../src/gcc-5.1.0/libcilkrts/include -I../../../../../src/gcc-5.1.0/libcilkrts/runtime -I../../../../../src/gcc-5.1.0/libcilkrts/runtime/config/x86 -DIN_CILK_RUNTIME=1 -fcilkplus -pthread -I/e/d/bs/.build/x86_64-unknown-linux-gnu/buildtools/include -I../../../../../src/gcc-5.1.0/libcilkrts/include -I../../../../../src/gcc-5.1.0/libcilkrts/runtime -I../../../../../src/gcc-5.1.0/libcilkrts/runtime/config/x86 -DIN_CILK_RUNTIME=1 -fcilkplus -std=c99 -g -Os -MT sysdep-unix.lo -MD -MP -MF .deps/sysdep-unix.Tpo -c ../../../../../src/gcc-5.1.0/libcilkrts/runtime/sysdep-unix.c  -fPIC -DPIC -o .libs/sysdep-unix.o
../../../../../src/gcc-5.1.0/libcilkrts/runtime/sysdep-unix.c: In function 'get_runtime_path':
../../../../../src/gcc-5.1.0/libcilkrts/runtime/sysdep-unix.c:626:5: error: unknown type name 'Dl_info'
     Dl_info info;
     ^
../../../../../src/gcc-5.1.0/libcilkrts/runtime/sysdep-unix.c:627:14: warning: implicit declaration of function 'dladdr' [-Wimplicit-function-declaration]
     if (0 == dladdr(dummy_function, &info)) return "unknown";
              ^
../../../../../src/gcc-5.1.0/libcilkrts/runtime/sysdep-unix.c:628:16: error: request for member 'dli_fname' in something not a structure or union
     return info.dli_fname;
                ^
Makefile:741: recipe for target 'sysdep-unix.lo' failed
make: *** [sysdep-unix.lo] Error 1

.. but E:\d\is\x86_64-unknown-linux-gnu\sysroot\usr\include\dlfcn.h exists.

Problem is, my dlfcn for build stuff ends up getting pulled in:
E:\Users\ray\gd\ctng\linux-target\sysdep-unix.i
# 603 "../../../../../src/gcc-5.1.0/libcilkrts/runtime/sysdep-unix.c"
